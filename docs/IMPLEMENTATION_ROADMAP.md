...
- [ ] `docker compose up` starts api, frontend, postgres, redis, qdrant containers without error.
- [ ] `GET /health` returns 200 from both host and container.
- [ ] `uv run pytest` passes with 1 test.
- [ ] Repo pushed with `main` branch and initial commit following conventional commits.
